...
![Signup Page](./comp3133-lab1/signup.png)

### Login
Sign in with your credentials.

![Login Page](./comp3133-lab1/signin.png)
...
![Live Chat Interface](./comp3133-lab1/livechat.png)

### Private Messaging
Send direct messages to other online users. Only the recipient can see these private conversations.

![Private Message Feature](./comp3133-lab1/private_message.png)

### Logout
Safely disconnect from the application.

![Logout Functionality](./comp3133-lab1/logout.png)
...
![MongoDB Database](./comp3133-lab1/mongo.png)
